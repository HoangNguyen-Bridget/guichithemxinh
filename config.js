const nameGirl = 'Chị à ';
const giftUrl = 'https://www.facebook.com/tham.lam.7731';
const eventName = 'Chúc Mừng 20-10';
const titleCard = 'Tặng người ấy';
const contentCard = 'Chúc honey của em ngày 20 tháng 10 ngày càng xinh đẹp hơn, ngày thành công hơn và tràn ngập niềm vui và những nụ cười. Mong mọi điều tốt đẹp nhất sẽ đến với chị ạ, iu chị nhiều ❤️';
